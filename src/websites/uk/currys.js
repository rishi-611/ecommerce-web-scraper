...
const websiteURL = "https://www.currys.co.uk/computing";
const country = "UK";
...
export const scrape = async (websiteURL, device) => {
  try {
    ...
    const $productTile = ".tablet-structure";
    const $productTitle = `.pdpLink`;
        ...
        products = products.filter((product) => {
          ...
          console.log(
            product.querySelector(
              ".list-of-features > li:nth-child(3) > .curry-sansreg-font"
            )?.textContent
          );
...
export const scrapeCurrys = async (devices) => {
  try {
